...
const projects: Project[] = [
  {
    ...
    techIcons: [
      "/assets/ros2_icon.svg",
      "/assets/gazebo_icon2.svg",
      "/assets/python_icon2.svg",
    ],
  ...
  },
  {
    ...
    description:
      "Autonomous track measurement unit for railway infrastructure using sensor fusion and data analytics to enable continuous infrastructure monitoring and predictive maintenance.",
    tech: [
      "Autonomous Systems",
      "Sensor Fusion",
  ...
  },
  {
    ...
    techIcons: [
      "/assets/solidworks_icon.svg",
      "/assets/dassault_icon.svg",
      "/assets/ros2_icon.svg",
    ],
    ...
    links: [
      ...
      {
        label: "Pilot Project",
        href: "https://www.certisgroup.com/certis-robotic-solutions/",
        icon: "external",
      },
    ],
  },
  {
    ...
    description:
      "Soft robotic fish with TPU soft actuator + YOLOv8 tracking for biomimetic underwater robotics",
    ...
    images: [
      "/assets/fish_proj.png",
      "/assets/fish_proj2.png",
      "/assets/fish_proj3.png",
      "/assets/fish_proj4.png",
    ],
  ...
  },
  {
    ...
    description: [
      "CrewAI agents, asynchronous pipelines for automated newsletter generation",
    ...
    techIcons: [
      "/assets/python_icon2.svg",
      "/assets/openai_icon.svg",
      "/assets/ollama_icon.svg",
    ],
    image: "/assets/news_proj.png",
    slug: "agentic-ai-newsletter-generator",
    myWork: [
      "Created multi-agent pipeline design using CrewAI agents and Ollama local LLMs, showcasing hierarchical, asynchronous tasks with callbacks and predefined outputs.",
      "Designed to illustrate an enhanced workflow for AI-driven newsletter automation tools.",
    ],
    skills: "AI Agents • LLMs • Multi-agent Systems • Prompt Engineering • Python",
    links: [{ label: "Github", href: "https://github.com/godheinstein/AI_newsletter", icon: "github" }],
  },
  {
    title: "Reinforcement Learning (Frozen Lake)",
    description: [
      "Consider a frozen lake with holes covered by patches of very thin ice. A robot must glide from the top left corner to the bottom right corner to pick up a frisbee.",
      "Implemented Q-learning, SARSA, Monte Carlo algorithms to solve the Frozen Lake problem.",
    ],
    tech: ["RL", "Q-Learning", "SARSA", "Python"],
    techIcons: [
      "/assets/python_icon2.svg",
      "/assets/matplotlib_icon.svg",
      "/assets/numpy_icon.svg",
    ],
    image: "/assets/frozen_proj.png",
    slug: "reinforcement-learning-frozen-lake",
    myWork: [
      "Implemented Q-learning, SARSA, and Monte Carlo methods from scratch to solve Frozen Lake.",
      "Compared learning dynamics and stability across algorithms.",
      "Expanded to a 10x10 grid and tested all 3 algorithms.",
      "Tuned hyperparameters, epsilon, number of episodes, and others.",
    ],
    skills:
      "Reinforcement Learning • Python • Matplotlib • NumPy • Data Structures and Algorithms • Object-Oriented Programming",
    links: [
      {
        label: "Github",
        href: "https://github.com/godheinstein/Frozen_lake_problem-Reinforcement_learning/tree/master",
        icon: "github",
      },
    ],
  },
  {
    ...
    description:
      "Built an autonomous navigation stack in ROS2 Nav2, A* path planning, Savitzky Golay smoothing, regulated pure pursuit control, to reliably traverse an obstacle maze.",
    ...
    myWork: [
      "Programmed regulated pure pursuit with curvature heuristics, proximity heuristics, and varying lookahead distances for robust tracking.",
      "Programmed Multi-cost Theta* as the path planner for efficient paths.",
    ...
    links: [{ label: "Github", href: "https://github.com/godheinstein/Autonomous_Navigation_ROS2", icon: "github" }],
    video: "/assets/nav_demo.mp4",
  },
  {
    title: "Soft Robot Control with DRL",
    description: [
      "Soft robots' compliant nature and non-linear dynamics make it difficult to model, control, and plan the trajectory of soft robots.",
      "Developed a deep reinforcement learning control framework for a tendon-driven soft robot, using A2C and PPO with LSTM actor–critic networks and imitation learning with decaying priors.",
    ],
    ...
    myWork: [
      "Programmed 2 DRL algorithms, Advantage Actor Critic (A2C) and Proximal Policy Optimisation (PPO).",
      "Optimised hyperparameters with Bayesian Optimisation.",
      "Designed an Actor-Critic neural network with LSTM and RNN using Tensorflow and Keras.",
    ],
    skills: "Deep Reinforcement Learning • Neural Networks • Imitation Learning • Python • Tensorflow • Keras",
    video: "/assets/drl_video.mp4",
    links: [{ label: "Github", href: "https://github.com/godheinstein/Soft_Robot_Control_Deep_Reinforcement_Learning/tree/master", icon: "github" }],
  },
  {
    title: "Drone Kalman Filter",
    description: [
      "Simulates a drone's flight behavior and implements a simplified Kalman Filter for robust state estimation.",
      "Accurately estimates position and velocity using multiple sensors for precise navigation and control in simulation.",
    ],
    ...
    myWork: [
      "Developed a behaviour node for automated takeoff, dynamic waypoint following, and controlled landing.",
      "Implemented a simplified Kalman Filter to fuse IMU, sonar, GPS, magnetic sensor, and barometer for real-time estimation.",
    ...
    links: [{ label: "Github", href: "https://github.com/godheinstein/Drone_Kalman_Filter", icon: "github" }],
  },
  {
    title: "Onyx Home Robot Assistant",
    description:
      "Onyx is an attachment on top of an existing roomba, and it serves as a robot assistant to move things around the house and help with daily household chores.",
  ...
  },
  {
    ...
    techIcons: [
      "/assets/eth_icon.svg",
      "/assets/walletconnect_icon.svg",
      "/assets/1inch_icon.svg",
      "/assets/polygon_icon.svg",
      "/assets/XMTP_icon.svg",
      "/assets/filecoin_icon.svg",
    ],
    image: "/assets/stable_proj.svg",
    slug: "stablehr-web3-app",
    myWork: [
      "Participated in ETHGlobal New York Hackathon building on Ethereum blockchain.",
      "WalletConnect and Web3Auth for wallet integration and account management.",
      "1Inch for crypto quote and swap APIs.",
      "Unlimit Onramp SDK for fiat to crypto conversions.",
      "Filecoin Web3Storage to store website assets.",
      "XMTP for integrated messaging protocol.",
      "Nouns artworks to add personality to the project.",
...
export default function ProjectDetail() {
  ...
  // Hooks must run unconditionally, even if project is not found.
  const [activeIndex, setActiveIndex] = useState(0);

  // Always scroll to top when slug changes (fixes “opens at bottom”).
  useEffect(() => {
              ...
              {media.length ? (
                <div className="relative w-full h-full">
                  <AnimatePresence mode="wait">
                    <motion.div
                      key={active ? `${active.kind}:${active.src}` : "empty"}
